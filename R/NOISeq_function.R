# NOISeq function for bestDEG
# Created by: Prasert Yodsawat
# Date created: 16 October 2020

run_NOISeq <- function(cts, coldata, ref, l2fc, fdr) {
  ...
  ## modified the order of level in coldata$condition to spacify reference level
